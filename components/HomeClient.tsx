...
import { CollectionSidebar, CollectionSidebarMobileTrigger } from "@/components/CollectionSidebar";
import type { GameData, CollectionSummary } from "@/lib/games";
...
export function HomeClient({
  ...
  return (
    <div className="min-h-screen bg-background print:bg-white flex">
      {/* Desktop Sidebar */}
      <CollectionSidebar
        ...
        <header className="bg-gradient-to-b from-card to-card/95 border-b border-border print:hidden sticky top-0 z-30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
            ...
            <div className="flex items-center justify-between gap-4">
              {/* Left: Mobile menu trigger + Title and meta */}
              <div className="flex items-center gap-2 flex-1 min-w-0">
                {/* Mobile sidebar trigger */}
                <CollectionSidebarMobileTrigger
                  collections={collections}
                  selectedCollectionId={selectedCollection?.id || null}
                  allGamesCount={totalGames}
                  isAdmin={isAdmin}
                ...
                <div className="flex-1 min-w-0">
                  {/* Back to All Games link when viewing a collection */}
                  {selectedCollection && (
                    <Link
                      href="/"
                      className="text-xs text-muted-foreground hover:text-primary transition-colors inline-flex items-center gap-1 mb-0.5"
                    >
          ...
          {games.length === 0 && !selectedCollection ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground mb-4">
                Add games to &quot;{selectedCollection.name}&quot; from Settings.
              </p>
              {isAdmin && (
                <Button asChild variant="outline">
                  <Link href="/settings?section=lists">
