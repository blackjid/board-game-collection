      ...
      <div className="p-5 flex flex-col items-center text-center flex-1">
        ...
        <div className="mt-auto">
          ...
          {showDescription && game.description && (
            <p className="text-stone-400 text-sm line-clamp-2 mt-3">{game.description}</p>
          )}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-6 py-12 animate-fade-in">
      <div className="max-w-2xl w-full text-center">
        ...
        {subtitle && <p className="text-stone-400 text-lg mb-8">{subtitle}</p>}
...
export default function ListPickerPage({ params }: PageProps) {
      ...
      <div className="h-screen w-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-stone-400 text-lg">
            {creatingSession ? "Creating session..." : "Loading list..."}
          </p>
        </div>
      </div>
    );
  ...
  if (games.length === 0) {
    return (
      <div className="h-screen w-screen bg-black flex items-center justify-center">
        <div className="text-center px-6">
          <h1 className="text-4xl font-black text-white mb-4">No Games Ready</h1>
  ...
  return (
    <div className="fixed inset-0 bg-black text-white overflow-hidden touch-pan-x touch-pan-y" style={{ paddingTop: "env(safe-area-inset-top)", paddingBottom: "env(safe-area-inset-bottom)" }}>
      ...
      <div className="relative z-10 h-full">
        ...
        {/* KIDS PLAYING */}
        {step === "kids" && (
          <WizardScreen title="Any kids playing?" subtitle="We'll find age-appropriate games">
        ...
        {/* MOOD / CATEGORY */}
        {step === "mood" && (
          <WizardScreen title="What are you in the mood for?" subtitle="Select one or more categories">
        ...
        {/* EXPANSIONS */}
        {step === "expansions" && (
          <WizardScreen title="Include expansions?">
        ...
        {step === "swipe" && (
          <div className="h-full flex flex-col pt-14 sm:pt-0">
            <div className="p-4 flex flex-wrap gap-2 items-center justify-center">
              <span className="text-stone-500 text-sm">{swipeGames.length} matches</span>
              {filters.players && (
                ...
                {swipeGames.length === 0 ? (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center px-6">
                      ...
                      {maybePile.length > 0 ? (
                        <>
                          <p className="text-stone-400 mb-6">You have {maybePile.length} games in your maybe pile</p>
                          <button
                            onClick={() => {
                ...
                <div className="flex items-center justify-center mb-4 sm:mb-5">
                  {maybePile.length > 0 ? (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">{maybePile.length} {maybePile.length === 1 ? 'maybe' : 'maybes'}</span>
          ...
          <div className="h-full flex flex-col pt-16 pb-4 px-4 sm:justify-center sm:pt-6 sm:px-6" data-allow-scroll>
            <div className="max-w-md w-full mx-auto text-center animate-scale-in flex-1 flex flex-col justify-center overflow-auto">
              ...
              <div className="shadow-2xl rounded-2xl overflow-hidden mb-4 sm:mb-8 flex-shrink min-h-0">
                <GameCardDisplay game={pickedGame} showDescription={false} />
              </div>
